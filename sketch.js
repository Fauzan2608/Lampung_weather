...
let url = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTubi-3OAnMSVK_OD1C3a1FGc3RH3xlyb2pR9wlFisUcrY-ePqeOq5bUJGcyoX8Qn1joXVA2NNg4CIL/pub?output=csv';
let dataSheet;
let urlAPI = "https://api.openweathermap.org/data/2.5/weather?q=Lampung&appid=1774b4f1fd6570e8155808b915cd7e01&units=metric";
...
function infoCuaca(x, y, data, fontsize){
  ...
  posX = x,
  posY = y + 3*fontsize)
  text("Titik embun = "+ data.main.humidity,
  posX = x,
  posY = y + 4*fontsize)
  text("Kelembaban = "+ data.main.pressure,
  posX = x,
  posY = y + 5*fontsize)
 }
